...
import { FoxCabaret } from '../src/lib/venues/fox';

async function run() {
    console.log('🚀 Starting Manual Fox Scraper Test...');
    ...
    try {
        console.log(`📡 Navigating to ${FoxCabaret.url}...`);
        await page.goto(FoxCabaret.url, { waitUntil: 'networkidle', timeout: 30000 });

        console.log('🔍 Scraping events...');
        const events = await FoxCabaret.scrape(page, null);
