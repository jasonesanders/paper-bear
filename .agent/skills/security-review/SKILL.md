...
allowed-tools: view_file, grep_search, find_by_name, run_command, task_boundary
license: LICENSE
---
...
| `.js`, `.ts`, `express`, `react`, `vue`, `next`, `.astro` | `languages/javascript.md`, `languages/astro.md` |
...
- `astro.md` - Astro-specific security patterns
